...
class SongUNet(torch.nn.Module):
    def __init__(self,
                 ...
                 label_dim=None,  # Number of class labels, 0 = unconditional.
...
class LinearSongUNet(torch.nn.Module):
    def __init__(self,
                 img_resolution,  # Image resolution at input/output.
                 in_channels,  # Number of color channels at input.
                 out_channels,  # Number of color channels at output.
...
class VPPrecond(torch.nn.Module):
    def __init__(self,
                 ...
                 model_type='SongUNet',  # Class name of the underlying models.
                 **model_kwargs,  # Keyword arguments for the underlying models.
                 ):
        super().__init__()
...
class iDDPMPrecond(torch.nn.Module):
    def __init__(self,
                 ...
                 M=1000,  # Original number of timesteps in the DDPM formulation.
                 model_type='DhariwalUNet',  # Class name of the underlying models.
                 **model_kwargs,  # Keyword arguments for the underlying models.
                 ):
        super().__init__()
        self.img_resolution = img_resolution
